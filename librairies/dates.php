...
function afficher_debut_fin($horaire_debut, $horaire_fin, $date_evenement)
{
	...
	if ($horaire_fin != date_lendemain($date_evenement)." 06:00:01" 
	&& $horaire_fin != "0000-00-00 00:00:00" 
	&& $horaire_debut != date_lendemain($date_evenement)." 06:00:01"
	&& $horaire_debut != "0000-00-00 00:00:00")
	{
		$afficher .= " – ";
	}
