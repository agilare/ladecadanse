...
<main id="contenu" class="colonne">
	...
	<article class="rubrique">
        <ul style="padding-left:.4em;">
            <li>
                <h2 style="font-size:1.2em">vous avez des événements à&nbsp;ajouter régulièrement, <a href="/user/register.php?contributor=1">inscrivez-vous</a> (ou <a href="/user/login.php">connectez-vous</a> si vous avez déjà un compte)</h2>
