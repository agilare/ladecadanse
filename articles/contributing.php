...
<main id="contenu" class="colonne">
    ...
    <article class="rubrique">
        ...
        <p>Merci de vous intéresser à ce projet qui est d&#39;une assez grande utilité pour <strong>faire connaître les événements de la région genevoise et ses environs</strong>. Les contributions sont bienvenues car il y a actuellement pas mal à faire, notamment dans la rénovation technique et visuelle.</p>
