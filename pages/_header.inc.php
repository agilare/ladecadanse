...
<?php } ?>
	...
	?>
		...
		<link rel="alternate" type="application/rss+xml" title="Prochains événements dans ce lieu" href="/pages/rss.php?type=lieu_evenements&amp;id='.$get['idL'] ?>" />
	<?php
	}
	else if ($nom_page == "evenement")
	{
	?>
		<link rel="alternate" type="application/rss+xml" title="Commentaires de cette événement" href="/pages/rss.php?type=evenement_commentaires&amp;id='.$get['idE'] ?>" />
