	...
	else if ($get['type'] == "lieu")
	{
		...
		if ($nbEvLieu > 0)
		{
			...
			while($tab_even = $connector->fetchArray($req_evLieu))
			{
				...
				<td><a href=\"/pages//user.php?idP=".$tab_even['idPersonne']."\" title=\"Voir le profile de la personne\">".$tab_even['idPersonne']."</a></td>
		...
		else if ($nbDesLieu > 0)
		{
			...
			{
				echo "<tr>
				<td><a href=\"/pages/user.php?idP=".$idPersonne."\" title=\"Voir le profile de la personne\">".$idPersonne."</a></td>";
		...
		if ($res_desc = $connector->fetchArray($req_desc))
		{
            ...
            <p><?php echo Text::wikiToHtml($descriptionlieu['contenu']) ?></p>
                ...
                <div class="auteur">
                    ...
                    <a href="/pages/multi-description.php?action=editer&amp;idL=<?php echo $descriptionlieu['idLieu'] ?>&amp;idP=<?php echo $descriptionlieu['auteur'] ?>">
                    Modifier</a>
                    </span>
