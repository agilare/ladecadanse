...
if (isset($_POST['formulaire']) && $_POST['formulaire'] === 'ok')
{
	...
	if ($verif->nbErreurs() == 0)
	{
		...
		12,
		$url_site,
		$url_site.'/pages/user-login.php?msg=faux',
		$champs['memoriser']
		);
	}
...
<form id="ajouter_editer" action="/pages/user-login.php" method="post">
<?php
...
<p class="mdp_oublie"><a href="/pages/user-reset.php" >Mot de passe oublié ?</a></p>
<p class="mdp_oublie"><a href="/pages/user-register.php" >Pas de compte ?</a></p>
