...
/*     if ($presentation != '')
	...
	$aff_menulieux .= ">
	<td><a href=\"/pages/organisateur.php?".Utils::urlQueryArrayToString($get, array("idO", "type_description"))."&amp;idO=".$id."\">";
	...
	$prec = "/pages/organisateur.php?vue=".$get['vue']."&amp;idO=".$id.$url_tranche."";
