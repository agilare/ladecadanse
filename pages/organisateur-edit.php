...
if (isset($_POST['formulaire']) && $_POST['formulaire'] == 'ok')
{
	...
	if ($form->traitement($_POST, $_FILES))
	{
        ...
        header("Location: /pages/organisateur.php?idO=".$form->id); die();
	}
}
...
if (($get['action'] == 'editer' || $get['action'] == 'update'))
{
	...
	if ($authorization->estAuteur($_SESSION["SidPersonne"], $get['idO'], "organisateur") || $_SESSION['Sgroupe'] <= 8)
	{
		...
		if ($_SESSION['Sgroupe'] < 2)
		{
			...
			<a href=\"/pages/multi-suppr.php?type=organisateur&amp;id=".$get['idO']."&token=".SecurityToken::getToken()."\">Supprimer</a></li>";
			$titre_actions .= '</ul>';
		}
