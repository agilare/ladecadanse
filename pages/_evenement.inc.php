...
{	
	...
	$nom_lieu = "<a href=\"/pages/lieu.php?idL=".$evenement['idLieu']."\" title=\"Voir la fiche du lieu : ".sanitizeForHtml($listeLieu['nom'])."\" >".htmlspecialchars($listeLieu['nom'])."</a>";
...
echo "<p><a href=\"/pages/agenda.php?courant=".$evenement['dateEvenement']."\" title=\"Agenda\">".ucfirst(date_fr($evenement['dateEvenement'], "annee"))."</a></p>";
?>
<div class="evenement">
...
<div class="titre">
	...
	echo '<a href="/pages/evenement.php?idE='.$evenement['idEvenement'].'" 
...
if (mb_strlen($evenement['description']) > $maxChar)
{
	...
	$maxChar, 
	" <a href=\"/pages/evenement.php?idE=".$evenement['idEvenement']."\" title=\"Voir la fiche complète de l'événement\"> Lire la suite".$iconeSuite."</a>");
}
else
{ 
