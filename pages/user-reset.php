...
if (isset($_POST['formulaire']) && $_POST['formulaire'] === 'ok' && empty($_POST['name_as']))
{
	...
	if ($verif->nbErreurs() == 0)
	{
		...
		if ($email_envoi)
		{
			...
			$contenu_message .= $url_site."/pages/user-reset2.php?token=".$token;
			$contenu_message .= "\n\n";
  ...
  'Content-type' => 'text/plain; charset="utf-8"');
            ...
            $logger->log('global', 'activity', "[motdepasse_demande] request by ".$to." ".$url_site."/pages/user.php?idP=".$idPersonne, Logger::GRAN_YEAR);
		}
		else
		{
