...
/*
	...
	if ($verif->nbErreurs() === 0)
	{
		...
		$contenu_message .= "\n\n";
		$contenu_message .= "Événement : ".$url_site."/pages/evenement.php?idE=".$champs['idEvenement'];
		$contenu_message .= "\n\n";
		...
		else
		{
                ...
                $logger->log('global', 'activity', "[signaler_erreur] by ".$from." for ".$url_site."/pages/evenement.php?idE=".$champs['idEvenement'], Logger::GRAN_YEAR);
