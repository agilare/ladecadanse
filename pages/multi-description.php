...
if (isset($_POST['formulaire']) && $_POST['formulaire'] === 'ok' )
{
	...
	if ($verif->nbErreurs() === 0)
	{
        ...
        header("Location: /pages/lieu.php?idL=".$champs['idLieu']); die();
...
if ($get['action'] == 'editer' || $get['action'] == 'update')
{
	...
	echo '
	<h2>Modifier la '.$get['type'].' sur <a href="/pages/lieu.php?idL='.$get['idL'].'" title="Fiche du lieu '.sanitizeForHtml($detailsLieu['nom']).'">'.sanitizeForHtml($detailsLieu['nom']).'</a></h2>';
...
if ($get['action'] == 'editer' && isset($get['idL']) && isset($get['idP']))
{
    ...
    if ($_SESSION['Sgroupe'] <= 4) 
    {
        ...
        <a href=\"/pages/multi-suppr.php?type=descriptionlieu&id=".$get['idL']."&idP=".$get['idP']."&token=".SecurityToken::getToken()."\">Supprimer</a></li>";
        echo "</ul>";
    }
