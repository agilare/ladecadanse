...
if ($connector->getNumRows($req_temp) == 1)
{
	...
	if (isset($_POST['formulaire']) && $_POST['formulaire'] === 'ok'  && empty($_POST['as_nom']))
	{
		...
		if ($verif->nbErreurs() === 0)
		{
			...
			{
				HtmlShrink::msgOk("Le mot de passe a été mis à jour, vous pouvez maintenant vous <a href='/pages/user-login.php'>connecter</a> avec votre identifiant et ce nouveau mot de passe");
