		...
		*/
		...
		elseif ($get['action'] == 'update')
		{
			...
			if ($req_update)
			{
				...
				HtmlShrink::msgOk('Salle du <a href="/pages/lieu.php?idL='.$champs['idLieu'].'" title="Fiche du lieu">lieu</a> modifiée');
...
if ($get['action'] == 'editer' && isset($get['idS']))
{
	...
	<a href=\"/pages/multi-suppr.php?type=salle&id=".$get['idS']."&token=".SecurityToken::getToken()."\" title=\"Supprimer la salle\">Supprimer</a></li>";
	echo "</ul>";
