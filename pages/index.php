...
?> 
	...
	<div id="entete_contenu">
        <h2 class="accueil" style="margin: 0;">Aujourd’hui <a href="/pages/rss.php?type=evenements_auj" title="Flux RSS des événements du jour" style="font-size:12px;vertical-align: top;" class="desktop"><i class="fa fa-rss fa-lg" style="color:#f5b045"></i></a></h2>
	...
	<section id="prochains_evenements" >
        ...
        <article class="evenement">
            ...
            <div class="titre">
                ...
                $titre_url = '
        <a href="/pages/evenement.php?idE='.$tab_even['idEvenement'].'&amp;tri_agenda='.$get['tri_agenda'].'&amp;courant='.$get['courant'].'"
        title="Voir la fiche complète de l\'événement">'.sanitizeForHtml($tab_even['titre']).'</a>';
            ...
            <div class="edition">
                ...
                <ul class="menu_action">
                    <li><a href="/pages/evenement-report.php?idE=<?php echo $tab_even['idEvenement']; ?>" class="signaler"  title="Signaler une erreur"><i class="fa fa-flag-o fa-lg"></i></a></li><li><a href="/pages/evenement_ics.php?idE=<?php echo $tab_even['idEvenement']; ?>" class="ical" title="Exporter au format iCalendar dans votre agenda"><i class="fa fa-calendar-plus-o fa-lg"></i></a></li>
                </ul>                
                ...
                if ($nb_comm > 0)
                {
                    ...
                    <a href="/pages/evenement.php?idE='.$tab_even['idEvenement'].'#commentaires"
    ...
    if ($connector->getNumRows($req_dern_even) > 0)
    {
        while ($tab_dern_even = $connector->fetchArray($req_dern_even))
        {
            ...
            if ($tab_dern_even['idLieu'] != 0)
            {
                ...
                $infosLieu = "<a href=\"/pages/lieu.php?idL=".$tab_dern_even['idLieu']."\" title=\"Voir la fiche du lieu : ".htmlspecialchars($tab_dern_even['nomLieu'])."\" >".htmlspecialchars($tab_dern_even['nomLieu'])."</a>";
            ...
            */
            ...
            echo "<h4>";
            $titre_url = "<a href=\"/pages/evenement.php?idE=".$tab_dern_even['idEvenement']."\" title=\"\" >".
            ...
            echo $infosLieu;
            echo "</h5>";
            echo "<p>le&nbsp;<a href=/pages/agenda.php?courant=".$tab_dern_even['dateEvenement'].">".date_fr($tab_dern_even['dateEvenement'])."</a></p><div class=\"spacer\"></div>";
            echo "</div>";
