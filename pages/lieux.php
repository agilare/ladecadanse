...
function initMap() {
	...
	jQuery.each(tab_markers, function() {
		...
		var contentString = '<div class="vd-marker-infowindow"><a href="/pages/lieu.php?idL=' + this['idLieu'] + '"><b>' + this['nom'] + '</b></a><br>' + this['categorie'] + '<br>' + this['adresse'] + '<br>' + this['quartier'];
...
<div id="contenu" class="colonne">
    ...
    <div id="entete_contenu">
        <h2 style="font-size:1.6em; width: 15%;">Lieux</h2> <?php if (isset($_SESSION['Sgroupe']) && $_SESSION['Sgroupe'] <= 6) { ?><a href="/pages/lieu-edit.php?action=ajouter" style="float: left;padding: 5px 1px;"><img src="/web/interface/icons/building_add.png" alt=""  /> Ajouter un lieu</a><?php } ?><?php HtmlShrink::getMenuRegions($glo_regions, $get); ?>
 ...
 <div style="clear:both"></div>
	...
	if ($connector->getNumRows($req_lieux_recents) > 0)
	{
		...
		?>
		<h3><a href="/pages/lieu.php?idL=<?php echo $tab_lieux_recents['idLieu']; ?>" title="Voir la fiche du lieu" ><?php echo $tab_lieux_recents['nom']; ?></a></h3>
...
<div id="colonne_droite" class="colonne">
    <?php include($rep_absolu."pages/_menulieux.inc.php");echo $aff_menulieux; ?>
</div>
<!-- Fin colonne_droite -->
