...
- **Charte éditoriale** — [`articles/charte-editoriale.php`](articles/charte-editoriale.php) annonce désormais six catégories. Sa description de « Fêtes » parle toujours d'une « part musicale », et aucun paragraphe ne décrit « Concerts » : à compléter si l'on veut y tracer la frontière entre les deux
