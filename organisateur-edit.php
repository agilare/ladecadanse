...
if (isset($get['idO']) && $form->getValeur('logo') != '' && $form->getErreur("logo") == '')
{
	...
	<div class="supImg">
                <?php echo "<img src=\"" . $assets->get(Organisateur::getAssetPath(Organisateur::getFilePath($form->getValeur('logo')))) . "\" alt=\"Logo pour " . sanitizeForHtml($form->getValeur('nom')) . "\" />"; ?>
                <div>
...
if (isset($get['idO']) && $form->getValeur('photo') != '' && $form->getErreur("photo") == '')
{
	...
	<div class="supImg">
                <?php echo "<img src=\"" . $assets->get(Organisateur::getAssetPath(Organisateur::getFilePath($form->getValeur('photo')))) . "\" alt=\"photo pour " . sanitizeForHtml($form->getValeur('nom')) . "\" />"; ?>
                <div>
