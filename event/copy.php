		...
		while ($dateIncrUnix <= $dateEUnix2)
		{
			...
			if ($connector->query($sql_insert))
			{
                ...
                $_SESSION['copierEvenement_flash_msg']['table'] .= '<tr>'
                    ...
                    . '<td>' . $edition . '<a href="/evenement-edit.php?action=editer&idE=' . (int) $nouv_id . '" title="Modifier cet événement" target="_blank">&nbsp;&nbsp;<i class="fa fa-external-link" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;<a href="#" id="btn_event_del_' . (int) $nouv_id . '" class="btn_event_del action_supprimer" data-id=' . (int) $nouv_id . ' data-token="' . SecurityToken::getToken() . '">Supprimer</a></td>'
                    . '</tr>';
