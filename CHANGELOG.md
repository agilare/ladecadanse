...
- register, user profile, lieu text edit : the three selects of active lieux drop their `actif=1` filter, on a column that had always been 1 and is now gone — `statut` is the real filter
