...
list((int) $annee_courant, $mois_courant, $jour_courant) = explode('-', $get['courant']);
...
if (is_numeric($annee_courant) && is_numeric($mois_courant) && is_numeric($jour_courant))
{
    if ($get['sem'] == 0)
    {
        ...
        $precedent = date("Y-m-d", mktime(0, 0, 0, (int) $mois_courant, (int) $jour_courant - 1, $annee_courant));
        ...
        $suivant = date("Y-m-d", mktime(0, 0, 0, (int) $mois_courant, (int) $jour_courant + 1, $annee_courant));
    ...
    else if ($get['sem'] == 1)
    {
        ...
        $suivant = date("Y-m-d", mktime(0, 0, 0, (int) $mois_courant, (int) $jour_courant + 7, $annee_courant));
