...
if ($get['element'] == 'evenement')
{
	...
	*/
	if ($get['action'] == 'ajouter')
	{
		...
		{
			HtmlShrink::msgOk("Favori de <a href=\"/evenement.php?idE=".$get['idE']."\" title=\"Voir la fiche du lieu\">".$iconeVoirFiche."l'événement</a> ajouté");
	...
	elseif ($get['action'] == 'supprimer')
	{
		...
		if ($req_update)
		{
			HtmlShrink::msgOk("Favori de <a href=\"/evenement.php?idE=".$get['idE']."\" title=\"Voir la fiche du lieu\">".$iconeVoirFiche."l'événement</a> supprimé");
		}
		else
		{
	...
	*/
	if ($get['action'] == 'ajouter')
	{
		...
		if ($connector->query($sql_insert))
		{
			...
			HtmlShrink::msgOk("Favori pour le <a href=\"/lieu.php?idL=".$get['idL']."\"
	...
	*/
	...
	elseif ($get['action'] == 'supprimer')
	{
		...
		if ($req_update)
		{
			...
			HtmlShrink::msgOk("Favori pour <a href=\"/lieu.php?idL=".$get['idL']."\" title=\"Voir la fiche du lieu\">".$iconeVoirFiche."le lieu</a> supprimé");
