...
return [
    ...
    // Niveau d'erreur minimum à signaler (0 = tout afficher, 5 = erreurs importantes)
    ...
    'directory_list' => [
        ...
        'vendor/codeception/module-phpbrowser/src',
        'vendor/codeception/module-rest/src',
        'vendor/filp/whoops/src/Whoops',
        'vendor/hoa/console',
        'vendor/phan/phan/src/Phan',
        'vendor/phpmailer/phpmailer/src',
        'vendor/phpstan/phpstan-deprecation-rules/src',
        'vendor/spaze/phpstan-disallowed-calls/src',
