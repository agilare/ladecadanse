...
<div id="contenu" class="colonne">
    ...
    <div class="rubrique">
        ...
        <p>La décadanse est un agenda culturel pour la région de Genève composé d’une sélection d’événements. Ceux-ci, ainsi que les lieux et organisateurs publiés sur le site doivent correspondre à certains critères qui définissent notre charte éditoriale.</p>
        ...
        <h4>Catégories</h4>
        <p>Les événements sont répartis en 5 catégories, dont voici des explications pour 3 d’entre-elles :</p>
        <h5><a id="Ftes_17"></a>Fêtes</h5>
        <p>Large rubrique où figurent les événements culturels, festifs avec très souvent une part musicale. Le volet culturel doit être prépondérant, les événements où celui-ci est trop secondaire ne sont pas admis; par ex. un dîner-concert où un groupe joue que pour l’ambiance.</p>
        ...
        <p>Ici apparaissent les événements ne trouvant pas leur places dans les autres rubriques et qui peuvent être peu ou pas artistiques tels que conférences, débats, cours/ateliers (à condition que ces derniers soient gratuits ou à prix modique), balades culturelles, brocantes, etc. qui ont un intérêt culturel et/ou social</p>
        <h4><a id="Ralit_26"></a>Réalité</h4>
        <p>Les événements doivent êtres dans le réel, c-à-d dans un lieu défini, avec un début et une fin, où des personnes se rencontrent vraiment; l’agenda ne peut donc contenir d’annonces d’actualité, de campagnes sur le web, d’émissions (radio, TV, web), etc.</p>
        <h4><a id="Types_non_admis_30"></a>Types non admis</h4>
        <ul>
        ...
        <p>Les tarifs peuvent varier beaucoup selon le type d’événement (soirée DJ, concerts, théâtre…) mais nous cherchons à ce qu’ils soient appropriés, et nous fixons une limite à 40.- CHF (à ce prix là, il s’agira plutôt d’une programmation riche ou une tête d’affiche). Des exceptions peuvent se produire, dans le cas par exemple d’un artiste spécifique, un événement avec de nombreuses activités (sur plusieurs jours par exemple), une part de soutien…</p>
        ...
        <p>Les lieux peuvent avoir différents niveaux de facilité d’accès, d’une entrée totalement libre à une entrée avec attente, fouille, exigence de tenue vestimentaire…
            Dans le même esprit que les autres critères, nous privilégions un accès aisé et un contrôle raisonnable, par contre ceux exigeant des critères strictes (tenue correcte, voire plus) ne sont pas publiés.</p>
        <h3><a id="LES_LIEUX_53"></a>Les lieux</h3>
        <p>Les lieux ayant une vocation commerciale trop prononcée ne sont pas souhaités (night-clubs, casinos, cabarets, multiplexes…). Pour pouvoir figurer dans la rubrique Lieux, des événements doivent être organisés régulièrement et ceux-ci doivent suivre les critères déjà présentés ci-dessus.
