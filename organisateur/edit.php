    ...
    <fieldset>
        ...
        <p>
            ...
            <?php /* Pas de maxlength : le navigateur compte un saut de ligne pour un caractère,
                     ...
                     Organisateur::FIELDS['admin_note'] refuse ensuite. */ ?>
            <textarea name="admin_note" id="admin_note" cols="50" rows="4"><?= sanitizeForHtml($organisateur_form->getValeur('admin_note')) ?></textarea>
            <?= $organisateur_form->getHtmlErreur("admin_note") ?>
        </p>
        <div class="guideChamp">Texte brut, que seuls les administrateurs voient : dans la liste des organisateurs et sur la fiche</div>
    </fieldset>
    <?php endif; ?>
